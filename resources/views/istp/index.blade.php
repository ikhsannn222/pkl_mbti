    ...
    <div class="contents">
        ...
        <div class="box hide" data-content="3">
            ...
            <div>
                ...
                <ul>
                    <li>Secara umum, orang dengan kepribadian ISTP cocok untuk berkarir pada perkerjaan yang melibatkan penalaran dan pengalaman langsung. Ini karena pribadi ISTP merupakan sosok yang praktis, realistis, dan memiliki kemampuan yang sangat baik untuk menerapkan pola pikir sebab-akibat.

                        Pribadi ISTP biasanya paling suka bekerja di lingkungan yang fleksibel, individualis, tidak banyak aturan, sekaligus memungkinkannya untuk menggunakan keterampilan pemecahan masalahnya yang luar biasa.

                        Jadi, dalam hal karir, orang-orang dengan kepribadian ISTP akan lebih cocok bekerja sebagai teknisi, mekanik, ahli forensik, programmer, ilmuwan, pilot, pengacara, hakim, pemadam kebakaran, atau fotografer.</li>
                </ul>
                <button onclick="location.href='{{route('tes.index')}}'" type="button" class="custom-btn btn-5">Test MBTI</button>
                <button onclick="location.href='/'" type="button" class="custom-btn btn-5">Homepage</button>
            </div>
