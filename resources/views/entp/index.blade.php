...
@keyframes moving {
    ...
    <div class="contents">
        ...
        <div class="box show" data-content="0">
            <img src="{{asset('backend/image/rabbids invasion icon.jpeg')}}" alt="">
            <div>
        ...
        <div class="box hide" data-content="2">
            <img src="{{asset('backend/image/rabbids invasion icon (3).jpeg')}}" alt="">
            <div>
                <h3>Kekurangan ENTP</h3>
                    <ul>
                        <li>Agresif</li>
        ...
        <div class="box hide" data-content="3">
            <img src="{{asset('backend/image/matching pfp (3_3).jpeg')}}" alt="">
            <div>
