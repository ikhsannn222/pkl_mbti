...
@keyframes moving {
    ...
    <div class="contents">
        ...
        <div class="box show" data-content="0">
            <img src="{{asset('backend/image/Librarian.jpeg')}}" alt="">
            <div>
                <h3>Hiii tipe kepribadian kamu adalahh INTJ(Si ahli strategi)</h3>
                <ul>
                   <li>INTJ adalah singkatan dari Introverted, Intuitive, Thinking, dan Judging. Sekitar 1–4% populasi dunia diperkirakan memiliki kepribadian INTJ. Orang dengan tipe kepribadian ini dikenal sebagai individu yang analitis, logis, dan kreatif. Oleh sebab itu, orang dengan kepribadian INTJ dijuluki sebagai “Si Ahli Strategi”.</li>
                </ul>
        ...
        <div class="box hide" data-content="1">
            <img src="{{asset('backend/image/kelebihan intj.jpeg')}}" alt="">
            <div>
                <h3>Kelebihan INTJ</h3>
                <ul>
                    <li>Objektif</li>
                    <li>Logis</li>
                    <li>Rasional</li>
        ...
        <div class="box hide" data-content="2">
            <img src="{{asset('backend/image/sad.jpeg')}}" alt="">
            <div>
                <h3>Kekurangan INTJ</h3>
                <ul>
                <li>Kaku</li>
        ...
        <div class="box hide" data-content="3">
            <img src="{{asset('backend/image/❝𝗿𝗮𝗯𝗯𝗶𝘁𝘀 𝗶𝗻𝘃𝗮𝘀𝗶𝗼𝗻 𝗶𝗰𝗼𝗻𝘀❞.jpeg')}}" alt="">
            <div>
                <h3>Ini diaa karir yang cocok</h3>
                <ul>
                    <li>Maka tidak mengherankan jika pekerjaan di bidang teknik, penelitian, sains, dan teknologi adalah pilihan umum bagi INTJ – namun bidang kreatif, mulai dari arsitektur, komposisi musik, hingga desain video game, juga dapat memuaskan sifat inovatif mereka.<li>
                </ul>
                <button onclick="location.href='{{route('tes.index')}}'" type="button" class="custom-btn btn-5">Test MBTI</button>
                <button onclick="location.href='/'" type="button" class="custom-btn btn-5">Homepage</button>
            </div>
