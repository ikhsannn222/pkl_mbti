                ...
                <div class="col-sm-9">
                    <div class="position-relative input-icon">
                        <input type="text" class="form-control @error('nama') is-invalid @enderror"
                            name="nama" value="{{ old('nama') }}" id="input42" placeholder="Masukan Nama">
                ...
                <div class="col-sm-9">
                    <div class="position-relative input-icon">
                        <input type="number" class="form-control @error('no_tlp') is-invalid @enderror"
                            name="no_tlp" value="{{ old('no_tlp') }}" id="input43" placeholder="No no_tlp">
                ...
                <div class="col-sm-9">
                    <div class="position-relative input-icon">
                        <input type="text" class="form-control @error('email') is-invalid @enderror"
                            name="email" value="{{ old('email') }}" id="input44" placeholder="Alamat Email">
