...
@keyframes moving {
    ...
    <div class="contents">
        ...
        <div class="box show" data-content="0">
            <img src="{{asset('backend/image/rabbids invasion icon (6).jpeg')}}" alt="">
            <div>
        ...
        <div class="box hide" data-content="1">
            <img src="{{asset('backend/image/(◍•ᴗ•◍)✧_。.jpeg')}}" alt="">
            <div>
                <h3>Kelebihan ENFP</h3>
                    <ul>
                        <li>- Ramah</li>
                        <li>- Persuasif</li>
                        <li>- Terorganisir</li>
        ...
        <div class="box hide" data-content="2">
            <img src="{{asset('backend/image/Business Rabbid___.jpeg')}}" alt="">
            <div>
                <h3>Kekurangan ENFP</h3>
                    <ul>
                        <li>- Emosional</li>
        ...
        <div class="box hide" data-content="3">
            <img src="{{asset('backend/image/rabbids invasion icon (7).jpeg')}}" alt="">
            <div>
                <h3>Ini dia karir yang cocok</h3>
                <ul>
                    <li>Individu P digambarkan sebagai pribadi yang sangat suka membantu orang lain dan memiliki kemampuan dalam memahami keinginan, kebutuhan, dan maksud orang lain.
