    ...
    <div class="contents">
        ...
        <div class="box hide" data-content="3">
            ...
            <div>
                ...
                <ul>
                    <li>Orang dengan kepribadian ESTJ memiliki beberapa karakteristik yang membuatnya cocok untuk karir-karir tertentu. Pribadi ESTJ umumnya sangat cocok pada karir yang berhubungan dengan pengawasan dan manajemen.

                        Pasalnya, tipe kepribadian ini umumnya adalah pribadi yang sangat tertib, patuh, terorganisir, dan teliti. Pribadi ESTJ juga selalu berusaha untuk mengikuti seluruh arahan dan peraturan yang ada pada tempatnya bekerja.

                        Pribadi ESTJ paling suka bekerja dalam lingkungan yang stabil dengan peran dan tanggung jawab yang jelas. Karir yang cocok bagi tipe kepribadian ESTJ antara lain polisi, tentara, hakim, politikus, pengacara, guru, manajer, akuntan, auditor, dan bankir</li>
                </ul>
                <button onclick="location.href='{{route('tes.index')}}'" type="button" class="custom-btn btn-5">Test MBTI</button>
                <button onclick="location.href='/'" type="button" class="custom-btn btn-5">Homepage</button>
            </div>
